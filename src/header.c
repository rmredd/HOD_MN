...
/* These are the global variables. When needed, each is set to the
...
int ITRANS=4,             /* Type of transfer function to be used */
  ...
  MN_COVAR=1,             /* Flag to use covariance matrix for M/N chi^2 */
  ...
  N_HOD_PARAMS=10,         /* number of possible parameters for HOD. for use w/ MCMC */
  N_COSMO_PARAMS=0,		  /* number of FREE cosmological parameters for use w/ MCMC and wp_minimization */
  ...
  GALDENS_CCORR = 0;      /* Flag to use galaxy density correction with cosmology */
